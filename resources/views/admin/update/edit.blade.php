    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">{{ __('main.Editupdate') }}</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <form action="{{ route('admin.update.update',$value->id) }}" method="post" id="form" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">  <a href="{{ url('/update/'. $value->file_id ) }}" download="download">{{ $value->file_id }}</a></div>
                                        @error('file_id')
