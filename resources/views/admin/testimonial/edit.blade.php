    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">{{ __('main.Edittestimonial') }}</h4>
                    </div>
                    <div class="col-sm-6">
        ...
        <div class="content">
            <div class="container-fluid">
                <form action="{{ route('admin.testimonial.update', $article->id) }}" method="post" id="form">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="slug">{{ __('main.testimonial') }}</label>
                                        <input type="text"
                                            class="form-control form-control-sm @error('slug') is-invalid @enderror" hidden
