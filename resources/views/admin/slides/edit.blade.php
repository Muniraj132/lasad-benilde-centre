                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control form-control-sm" id="urltext" name="bg" value="{{$slide->bg}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" id="category" name="category_id">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" @if (old('category_id') ?? $slide->category_id  == $category->id) selected @endif>
